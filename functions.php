...
function startnext_scripts() {
    ...
    // RTL CSS
    if( isset( $startnext_opt['enable_rtl']) ):
        if( $startnext_opt['enable_rtl'] == true ):
...
function startnext_import_files() {
	return array(
		array(
			'import_file_name'             => esc_html__('Import demo with Elementor Page Builder', 'startnext'),
			'local_import_file'            => trailingslashit( get_template_directory() ) . '/lib/demo-data/el/startnext-demo.xml',
			'local_import_widget_file'     => trailingslashit( get_template_directory() ) . '/lib/demo-data/el/startnext-widgets.json',
            'local_import_customizer_file' => trailingslashit( get_template_directory() ) . '/lib/demo-data/el/startnext-customizer.dat',
            'local_import_redux'           => array(
                array(
                    'file_path'   => trailingslashit( get_template_directory() ) . '/lib/demo-data/el/redux-options.json',
                    'option_name' => 'startnext_opt',
                ),
            ),
			'import_notice'    => __( 'Before import demo data please make sure you activate Elementor Page Builder', 'startnext' ),
        ),
        
        array(
			'import_file_name'             => esc_html__('Import demo with WPBakery Page Builder', 'startnext'),
			'local_import_file'            => trailingslashit( get_template_directory() ) . '/lib/demo-data/wpb/startnext-demo.xml',
			'local_import_widget_file'     => trailingslashit( get_template_directory() ) . '/lib/demo-data/wpb/startnext-widgets.json',
            'local_import_customizer_file' => trailingslashit( get_template_directory() ) . '/lib/demo-data/wpb/startnext-customizer.dat',
            'local_import_redux'           => array(
                array(
                    'file_path'   => trailingslashit( get_template_directory() ) . '/lib/demo-data/wpb/redux-options.json',
                    'option_name' => 'startnext_opt',
                ),
            ),
			'import_notice'                => __( 'Before import demo data please make sure you activate WPBakery Page Builder', 'startnext' ),
		),
	);
}
